...
@section('body')
  <section class="content-header">
    <h1>
      {{ __('translations.edit') }}  {{ __('translations.quantity') }} {{ __('translations.for_store') }} (( {{ $order->store->name }} ))
    </h1>
  </section>
  <!-- Main content -->
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary" style="padding-right: 10px;">
                  <!-- form start -->
                  {!! Form::open(['route' => 'shipedorders.edit.quantity.save', 'files' => true, 'enctype' =>'multipart/form-data']) !!}
              ...
              <div class="form-group{{$errors->has('quantity') ? 'error' : null}}">
                  ...
                  <input type="number" min="0" max="999999" class="form-control" id="" name="quantity" value="{{$order->quantity}}">
              </div>
