...
@section('body')
  <section class="content-header">
    <h1>
      {{ __('translations.edit') }} {{ __('translations.shiporder_id') }} {{ __('translations.for_store') }} (( {{ $order->store->name }} ))
    </h1>
  </section>
  <!-- Main content -->
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary" style="padding-right: 10px;">
                  <!-- form start -->
                  {!! Form::open(['route' => 'shipedorders.edit.shiporder_id.save', 'files' => true, 'enctype' =>'multipart/form-data']) !!}
