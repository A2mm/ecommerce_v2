        ...
        <div class="box box-primary" style="padding-right: 10px;">
                  ...
                  <table class="table table-bordered table-striped">
                    ...
                    <tr>
                      ...
                      <td>  
                        @if($user->can('edit settles store') || $user->can('Administer'))
                        <a href="{{ route('settles.edit.store_id', ['id' => $order->id]) }}" class="btn btn-primary btn-xs"> {{ __('translations.edit') }} 
                       @endif 
                     </a> 
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td> {{ $order->settle_id }}  </td>
                      <td> 
                        @if($user->can('edit settles number') || $user->can('Administer'))
                        <a href="{{ route('settles.edit.settle_id', ['id' => $order->id]) }}" class="btn btn-primary btn-xs"> {{ __('translations.edit') }} 
                         @endif 
                       </a>
                      </td>
                    </tr>
                   ...
                   <tr>
                     ...
                     <td> 
                      @if($user->can('edit settles product') || $user->can('Administer'))
                      <a href="{{ route('settles.edit.product_id', ['id' => $order->id]) }}" class="btn btn-primary btn-xs"> {{ __('translations.edit') }}
                       @endif 
                        </a> 
                     </td>
                   </tr>
                    ...
                    <tr>
                     ...
                     <td> 
                      @if($user->can('edit settles quantity') || $user->can('Administer'))
                      <a href="{{ route('settles.edit.quantity', ['id' => $order->id]) }}" class="btn btn-primary btn-xs"> {{ __('translations.edit') }} 
                         @endif 
                      </a> 
                     </td>
                   </tr>
