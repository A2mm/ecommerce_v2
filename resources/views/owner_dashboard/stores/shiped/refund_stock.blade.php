...
@section('body')
  <section class="content-header">
    <h1>
      {{ __('translations.refund_stock') }}  (( {{ $this_store->name }} ))
    </h1>
  </section>
  <!-- Main content -->
...
*/ ?>
                  <!-- form start -->
                  {!! Form::open(['route' => 'refund.stock.save', 'files' => true, 'enctype' =>'multipart/form-data']) !!}
                    ...
                    <input class="form-control" value="{{$this_store->id}}" type="hidden" name="store_id">
                      ...
                      <div class="form-group">
                        ...
                        <input class="form-control" value="{{old('refund_id')}}" type="number" name="refund_id">
                      </div>
