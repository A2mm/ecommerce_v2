...
@section('body')
  <section class="content-header">
    <h1>
      {{ __('translations.add_shiporder') }} {{ __('translations.for_store') }} (( {{ $order->store->name }} ))
    </h1>
  </section>
  <!-- Main content -->
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary" style="padding-right: 10px;">
                  <!-- form start -->
                  {!! Form::open(['route' => 'ship.known.order.save', 'files' => true, 'enctype' =>'multipart/form-data']) !!}
                    ...
                    <input class="form-control" value="{{$order->shiporder_id}}" type="hidden" name="shiporder_id">
                    ...
                    <div class="form-group">
                        <label for="name"> * {{__('translations.shiporder')}}</label>
                          <input style="width: 250px;" disabled="disabled" class="form-control" value="{{$order->shiporder_id}}" type="number" name="shiporder_id">
                    </div>
