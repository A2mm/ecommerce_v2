    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary" style="padding-right: 10px;">
                  <!-- form start -->
                  {!! Form::open(['route' => 'transfers.edit.quantity.save', 'files' => true, 'enctype' =>'multipart/form-data']) !!}
              ...
              <div class="form-group{{$errors->has('quantity') ? 'error' : null}}">
                  ...
                  <input type="number" min="0" class="form-control" id="" name="quantity" value="{{abs($order->quantity)}}">
              </div>
