...
@section('body')
  <section class="content-header">
    <h1>
      {{ __('translations.add_transfer_from_store') }} (( {{ $order->store->name }} ))
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary" style="padding-right: 10px;">
                  <!-- form start -->
                  {!! Form::open(['route' => 'stock.add.transfer.save', 'files' => true, 'enctype' =>'multipart/form-data']) !!}
              ...
              <input class="form-control" value="{{$order->from_store}}" type="hidden" name="from_store">
              <input class="form-control" value="{{$order->to_store}}" type="hidden" name="to_store">     
              <input class="form-control" value="{{$order->transfer_id}}" type="hidden" name="transfer_id">           
              ...
              <div class="form-group{{$errors->has('store_id') ? 'error' : null}}">
                    ...
                    <div class="form-group">
                        <label for="name"> * {{__('translations.transfer_number')}}</label>
                          <input style="width: 250px;" disabled="disabled" class="form-control" value="{{$order->transfer_id}}" type="number" name="transfer_id">
                    </div>
