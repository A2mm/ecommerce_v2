...
@section('body')
  <section class="content-header">
    <h1>
      {{ __('translations.add_refund') }} {{ __('translations.for_store') }} (( {{ $order->store->name }} ))
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary" style="padding-right: 10px;">
                  <!-- form start -->
                  {!! Form::open(['route' => 'stock.add.refund.save', 'files' => true, 'enctype' =>'multipart/form-data']) !!}
              ...
              <input class="form-control" value="{{$order->refund_id}}" type="hidden" name="refund_id">             
              ...
              <div class="form-group{{$errors->has('store_id') ? 'error' : null}}">
                    ...
                    <div class="form-group">
                        <label for="name"> * {{__('translations.refund_number')}}</label>
                          <input style="width: 250px;" disabled="disabled" class="form-control" value="{{$order->refund_id}}" type="number" name="refund_id">
                    </div>
