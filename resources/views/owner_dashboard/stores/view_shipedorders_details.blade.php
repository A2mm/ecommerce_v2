...
@section('body')
  <section class="content-header">
    <h1>
      {{ __('translations.edit_shiporder') }}
        ...
        <div class="box box-primary" style="padding-right: 10px;">
                  ...
                  <table class="table table-bordered table-striped">
                    ...
                    <tr>
                      ...
                      <td>  
                        @if($user->can('edit shipedorders store') || $user->can('Administer'))
                        <a href="{{ route('shipedorders.edit.store_id', ['id' => $order->id]) }}" class="btn btn-primary btn-xs"> {{ __('translations.edit') }} 
                       @endif 
                     </a> 
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td> {{ $order->shiporder_id }}  </td>
                      <td> 
                        @if($user->can('edit shipedorders number') || $user->can('Administer'))
                        <a href="{{ route('shipedorders.edit.shiporder_id', ['id' => $order->id]) }}" class="btn btn-primary btn-xs"> {{ __('translations.edit') }} 
                         @endif 
                       </a>
                      </td>
                    </tr>
                   ...
                   <tr>
                     ...
                     <td> 
                      @if($user->can('edit shipedorders product') || $user->can('Administer'))
                      <a href="{{ route('shipedorders.edit.product_id', ['id' => $order->id]) }}" class="btn btn-primary btn-xs"> {{ __('translations.edit') }}
                       @endif 
                        </a> 
                     </td>
                   </tr>
                    ...
                    <tr>
                     ...
                     <td> 
                      @if($user->can('edit shipedorders quantity') || $user->can('Administer'))
                      <a href="{{ route('shipedorders.edit.quantity', ['id' => $order->id]) }}" class="btn btn-primary btn-xs"> {{ __('translations.edit') }} 
                         @endif 
                      </a> 
                     </td>
                   </tr>
