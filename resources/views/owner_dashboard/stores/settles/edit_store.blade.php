...
@section('body')
  <section class="content-header">
    <h1>
      {{ __('translations.edit_settle') }} {{ __('translations.for_store') }} (( {{ $order->store->name }} ))
    </h1>
  </section>
  <!-- Main content -->
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary" style="padding-right: 10px;">
                  <!-- form start -->
                  {!! Form::open(['route' => 'settles.edit.store_id.save', 'files' => true, 'enctype' =>'multipart/form-data']) !!}
