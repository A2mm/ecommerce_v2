...
<div class="row">
  <div class="col-md-9">
              ...
              <form class="form form-horizontal" method="get" action="{{route('manage.quantity.lessThanZero')}}">
                 <div class="row">
       <div class="col-md-3">
 ...
 <div class="col-md-2" style="margin-right: -25px;">
   <button style="height: 33px;" type="submit" class="btn btn-sm btn-primary"> <i class="fa fa-search"></i> {{ __('translations.search') }}</button> </div>
     ...
     <?php /*
<div class="col-md-2">
   <a style="height: 33px;" class="btn btn-sm btn-danger back_home" href="{{ route('manage.quantity.lessThanZero') }}">
     {{ __('translations.back_home') }} <i class="fa fa-arrow-left"></i> </a>
</div> */ ?>
</div>
<a class="btn  btn-success" style="margin: 2px;" href="{{ route('excel.quantity.lessZero')}}">
