...
@section('body')
  ...
  <div class="col-md-9">
              ...
              <form class="form form-horizontal" method="get" action="{{route('manage.quantity.zero')}}">
                 <div class="row">
       <div class="col-md-3">
...
<div class="col-md-2">
   <a style="height: 33px;" class="btn btn-sm btn-danger back_home" href="{{ route('manage.quantity.zero') }}">
     {{ __('translations.back_home') }} <i class="fa fa-arrow-left"></i> </a>
</div> */ ?>
</div>
<a class="btn  btn-success" style="margin: 2px;" href="{{ route('excel.quantity.zero')}}">
