...
<div class="col-md-2 sub">
  <br>
   <a style="height: 33px;" class="btn btn-sm btn-danger back_home" href="{{ route('owner.requests') }}"> 
...
<?php // end check products phone ?>
   ...
   {!! $requests->appends(['search_day' => $search_day, 'from_hour' => $from_hour, 'to_hour' => $to_hour])->render() !!} 
</div>
