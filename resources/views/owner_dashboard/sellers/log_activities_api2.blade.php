...
@section('body')
  ...
  <section class="content-header">
    <h1>
      {{__('translations.selling_requests')}}
    </h1>
  </section>
            ...
            <tr>
              ...
              <?php /*  @if(strstr($item->url, '?'))
                ...
                @endif
                 ...
                 {{ __('translations.seller_products') }}
                 @endif

                 @if($item->request && strstr($item->url, 'checkProducts/phone?'))
                 {{ __('translations.checkProducts_phone') }}
                 @endif
              </td>
              <td>
...
<!-- // end check products prices by phone request -->
          ...
          @endif
              ...
              @if($item->response && strstr($item->url, 'store/last/7/days') && !strstr($item->url, 'store/last/7/days/history?'))
