...
@if($search_day == null)
 <a style="height: 33px;" class="btn disabled btn-sm btn-success" href="{{route('panelLog.excel', ['search_day' => $search_day, 'from_hour' =>$from_hour, 'to_hour' => $to_hour])}}">
       {{ __('translations.excel') }}
    <i class="fa fa-file-excel-o" aria-hidden="true"></i> </a>
@else
   <a style="height: 33px;" class="btn btn-sm btn-success" href="{{route('panelLog.excel', ['search_day' => $search_day, 'from_hour' =>$from_hour, 'to_hour' => $to_hour])}}">
       {{ __('translations.excel') }}
    <i class="fa fa-file-excel-o" aria-hidden="true"></i> </a>
@endif
  ...
  <section class="content">
   ...
   {!! $records->appends(['search_day' => $search_day, 'from_hour' => $from_hour, 'to_hour' => $to_hour, 'subject_type' => $subject_type, 'description' => $description])->render() !!} 
</div>
