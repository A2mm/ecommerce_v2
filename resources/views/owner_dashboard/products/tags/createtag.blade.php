    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
                  <!-- form start -->
                  {!! Form::open(['route' => 'product.createtag.save', 'files' => true, 'enctype' =>'multipart/form-data']) !!}

                    <div class="box-body">
                     <input type="hidden" name="product_id" value="{{$product->id}}"><br>
                     <label>* {{ __('translations.product') }} </label>
                    <input class="form-control" type="text" disabled="disabled" name="product" value="{{$product->name}}">
