  ...
  <form id="subb"> 
       ...
       <select class="form-control" id="sub" name="Subcategory">
        ...
        @if(isset(request()->Subcategory))
	        @if($subcategory->id == request()->Subcategory)
	        	selected="selected"
	        @endif
        @endif
        ...
        @endforeach
      <option value="ALL" @if(!isset(request()->Subcategory) || request()->Subcategory == 'ALL')selected="selected"@endif >All Subcategory</option>
       ...
       <select class="form-control" id="acc" name="accessory">
        ...
        <option value="{{$accessory->id}}"
         @if(isset(request()->accessory))
	        @if($accessory->id == request()->accessory)
	        	selected="selected"
	        @endif
        @endif
        ...
        @endforeach
      <option value="ALL" @if(!isset(request()->accessory) || request()->accessory == 'ALL')selected="selected"@endif >All Accessories</option>
